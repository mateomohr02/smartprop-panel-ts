  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        actionButton:"bg-custom-primary rounded-xl px-4 py-2 hover:bg-custom-secondary text-custom-text",
        sidebar: "hover:bg-custom-secondary text-custom-text dark:hover:bg-custom-secondary",
        theme:"hover:bg-custom-secondary text-custom-text dark:hover:bg-custom-secondary border border-custom-text/20 shadow-xs"
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-10 rounded-md px-6 has-[>svg]:px-4",
        sidebar:"h-14 rounded-none border-b border-custom-text/20 w-full",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
